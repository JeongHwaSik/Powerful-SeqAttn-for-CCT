...
setting_dict = dict(
    cifar100="data --dataset-name CIFAR100 --train-size 32 32 --train-resize-mode RandomResizedCrop --random-crop-scale 0.8 1.0 --test-size 32 32 --center-crop-ptr 1.0 --interpolation bicubic --mean 0.5071 0.4867 0.4408 --std 0.2675 0.2565 0.2761 --auto-aug rand-m9-mstd0.5-inc1 --cutmix 1.0 --mixup 0.8 --remode 0.25 --drop-path-rate 0.0 --smoothing 0.1 --batch-size 128 --epoch 600 --lr 5e-4 --warmup-lr 1e-6 --min-lr 1e-5 --warmup-epoch 10 --optimizer adamw --weight-decay 6e-2 --scheduler cosine --num-workers 4 --pin-memory --amp --channels-last",
)
...
def pass_required_variable_from_previous_args(prev_args=None):
    if prev_args:
